...
occa::memory o_rhsv, o_rt;
  ...
  string error_filename = "SWE_curve_h_" + to_string( N ) + "_" + to_string( K1D );
  ...
  error_filename = "SWE_curve_hu_" + to_string( N ) + "_" + to_string( K1D );
  error_filename += "_" + to_string( CFL ) + "_" + to_string( FinalTime );
  ...
  error_filename = "SWE_curve_hv_" + to_string( N ) + "_" + to_string( K1D );
  error_filename += "_" + to_string( CFL ) + "_" + to_string( FinalTime );
  SWE_error_file.open( error_filename.c_str() );
  ...
  string filename = "SWE_curve_result_Lx";
  filename += to_string( (int) Lx ) + "_Ly" + to_string( (int) Ly ) + ".csv";
