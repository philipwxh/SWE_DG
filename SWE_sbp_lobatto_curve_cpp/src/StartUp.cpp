...
void InitRefTri(Mesh *mesh, int N, bool sbp){
  ...
  // nodal points 
  VectorXd node_r,node_s,node_t;

  Nodes3D(N,node_r,node_s,node_t); // get 3D nodes 
  VectorXd r, s;
...
void MakeNodeMapsPeriodic2d(Mesh *mesh, MatrixXd xf, MatrixXd yf, double DX, double DY, MatrixXi &mapP){
  ...
  printf("num xfaces = %lu, num yfaces = %lu\n",xfaces.size(),yfaces.size());
  //cout << "xf = " << xf << endl;
  //cout << "yf = " << yf << endl;  
...
void MakeNodeMapsPeriodic3d(Mesh *mesh, MatrixXd xf, MatrixXd yf, MatrixXd zf,
  ...
  printf("num xfaces = %lu, num yfaces = %lu, num zfaces = %lu\n",xfaces.size(),yfaces.size(),zfaces.size());
  //  cout << "xf = " << xf << endl;
  //  cout << "yf = " << yf << endl;
  //  return;
